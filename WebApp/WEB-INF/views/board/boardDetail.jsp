				...
				<table class="boardTable">
					<tr>
						<td colspan="4" class="aTag">
							<a href="/Day12_MySite/board/list" class="left">LIST</a>
					...
					<tr>
						<td colspan="4" class="btn">
							<input type="button" onclick="location.href='/Day12_MySite/board/delete/${requestScope.board.no }'" value="DELETE">
							&nbsp;&nbsp;&nbsp;
							<input type="button" onclick="location.href='/Day12_MySite/board/update/${requestScope.board.no }'" value="UPDATE">
						</td>
					</tr>
					</c:if>
				</table>
